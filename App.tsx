...
const TopBar = () => {
  ...
  const handlePurchaseClick = () => {
    if (typeof window !== 'undefined' && (window as any).fbq) {
      ...
      (window as any).fbq('track', 'Purchase', { currency: 'USD', value: 6.99 });
    }
  };
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-white border-b border-purple-100 ${isScrolled ? 'py-2 shadow-md' : 'py-3 shadow-sm'}`}>
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0">
        ...
        <a
          href={timeLeft > 0 ? "https://payhip.com/b/gZaz8" : "#"}
...
const Countdown = ({ text = "⏳ Oferta por tiempo limitado:", expiredText = "Promoción finalizada" }) => {
...
const CTAButton = ({ text = "Comprar ahora y acceder inmediatamente", className = "" }) => {
  const handlePurchaseClick = () => {
    if (typeof window !== 'undefined' && (window as any).fbq) {
      (window as any).fbq('track', 'InitiateCheckout');
      (window as any).fbq('track', 'Purchase', { currency: 'USD', value: 6.99 });
    ...
    <div className="flex flex-col items-center w-full">
      ...
      >
        ...
        <span className="text-sm md:text-base font-medium mt-1 opacity-90 flex items-center gap-1">
          <ShieldCheck className="w-4 h-4 md:w-5 md:h-5" /> (Compra 100% segura) <span className="text-red-300 font-bold ml-1">Los impuestos pueden variar según el país.</span>
        </span>
      </motion.a>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800 selection:bg-pink-200 selection:text-pink-900 overflow-x-hidden pt-16 md:pt-20">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-purple-600 text-white font-bold text-base md:text-lg mb-8 shadow-md border border-purple-500">
              ...
              Para emprendedores creativos en toda Latinoamérica y Estados Unidos
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-purple-950 leading-[1.2] tracking-tight max-w-5xl mx-auto">
              Crea y vende productos personalizados con más de <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">1,700 páginas y plantillas listas para usar en Canva</span>
            </h1>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl text-gray-700 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                Ideal para emprendedores que quieren generar ingresos en temporadas de alta demanda sin empezar desde cero.
              </p>
              ...
              <div className="mb-12 flex flex-col items-center lg:items-start">
                <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-2xl border border-pink-100 shadow-sm mb-6 inline-flex flex-col md:flex-row items-center gap-4 md:gap-8">
                  <div>
                    <p className="text-gray-500 line-through text-lg">Antes: <span className="underline">19 USD</span></p>
                    <p className="text-2xl font-black text-pink-600 flex items-center justify-center lg:justify-start gap-2">
                      🔥 Ahora: 6.99 USD
                    </p>
                    <p className="text-sm text-red-600 text-center lg:text-left mt-1 font-bold">Los impuestos pueden variar según el país.</p>
                  </div>
                ...
                <CTAButton />
                <a href="#contenido" className="mt-6 text-purple-600 font-bold text-lg hover:text-purple-800 underline transition-colors">
                  Ver lo que incluye
                </a>
              </div>
            </motion.div>
      ...
      <section id="contenido" className="py-24 px-4 bg-fuchsia-50/30">
        <div className="max-w-6xl mx-auto">
          <SectionHeading 
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              "No saber qué vender en temporadas de alta demanda.",
              "Perder tiempo creando diseños desde cero.",
              "No tener ideas de productos para fechas especiales.",
              "Querer emprender desde casa pero no saber por dónde empezar.",
              "Sentir que no tienes habilidades de diseño."
            ].map((problem, i) => (
              <motion.div 
                initial={{ opacity: 0, x: -20 }}
      ...
      <section className="py-20 px-4 bg-purple-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl mb-12 leading-relaxed text-purple-100">
            El kit incluye <strong className="text-white">más de 1,700 páginas y plantillas editables en Canva</strong> listas para personalizar y vender.
          </p>
          
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              { title: "Empieza a vender", desc: "Sin necesidad de diseñar desde cero." },
              { title: "Ahorra tiempo", desc: "Diseños listos para personalizar con tu marca." },
              { title: "Uso comercial", desc: "Permitido para vender tus productos finales físicos." }
            ].map((feature, i) => (
      ...
      {/* SECCIÓN 4 — ¿PARA QUIÉN ES ESTE KIT? */}
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <SectionHeading title="¿Para quién es este Kit?" />
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              "Papelerías creativas",
              "Negocios de sublimación",
              "Emprendedores de productos personalizados",
              "Personas que venden detalles, regalos o manualidades",
              "Cualquiera que busque ingresos extra en fechas especiales"
            ].map((benefit, i) => (
              <motion.div 
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
            ...
            {[
              ...
              { icon: Printer, title: "5. Imprimes y vendes tus productos físicos" }
            ].map((step, i) => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-lg border-2 border-pink-200 relative flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-6 flex-grow">Calculadora para poner precios correctos a tus productos y asegurar tu ganancia.</p>
              <div className="flex items-center justify-center gap-3 bg-pink-50 py-3 px-4 rounded-xl border border-pink-100 mt-auto">
                <span className="text-gray-400 line-through font-medium text-lg">$7 USD</span>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg border-2 border-pink-200 relative flex flex-col h-full">
              ...
              <p className="text-xl font-bold text-gray-800 mb-4">Guía para Empezar a Vender</p>
              <p className="text-gray-600 mb-6 flex-grow">Aprende estrategias efectivas para vender tus productos en temporadas altas.</p>
              <div className="flex items-center justify-center gap-3 bg-pink-50 py-3 px-4 rounded-xl border border-pink-100 mt-auto">
                <span className="text-gray-400 line-through font-medium text-lg">$5 USD</span>
                <span className="text-pink-600 font-black text-xl">¡Ahora $0!</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 mb-10 border border-white/20 relative">
              <div className="flex flex-col items-center justify-center mb-4">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-2xl text-gray-400 line-through">~~<span className="underline">19 USD</span>~~</p>
                </div>
              </div>
              <div className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-yellow-300 mb-2 drop-shadow-sm flex flex-col md:flex-row items-center justify-center gap-4">
                ...
                <span>6.99 <span className="text-3xl">USD</span></span>
              </div>
              <p className="text-xl text-red-500 mb-6 font-bold">Los impuestos pueden variar según el país.</p>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-pink-200">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-purple-950">
              ¿QUÉ SIGNIFICA QUE EL KIT INCLUYE MÁS DE 1,700 PÁGINAS Y PLANTILLAS?
            </h2>
          </div>
          ...
          <p className="text-lg text-gray-800 font-bold bg-pink-100/50 p-4 rounded-xl border border-pink-200">
            Sumando todas las páginas y diseños incluidos, el kit contiene más de 1,700 páginas y plantillas que pueden editarse o utilizarse dentro de Canva.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-purple-100">
            <FAQItem 
              ...
              answer={`No necesariamente.\nMuchas plantillas utilizan elementos gratuitos de Canva.\n\nSi alguna incluye elementos Pro, puedes reemplazarlos fácilmente por elementos gratuitos dentro de la plataforma.`} 
            />
            <FAQItem 
              question="¿Es pago único?" 
              answer={`Sí, realizas un único pago y tienes acceso de por vida a las plantillas.`} 
            />
            <FAQItem 
              question="¿Cómo recibo el producto?" 
              answer={`Una vez confirmado el pago, recibirás un correo electrónico con el acceso inmediato a todo el contenido digital.`} 
            />
            <FAQItem 
              question="¿Puedo vender con esto?" 
              answer={`¡Claro que sí! El kit está diseñado exactamente para eso. Puedes personalizar las plantillas y vender los productos físicos finales a tus clientes.`} 
            />
            <FAQItem 
              question="¿Funciona en cualquier país?" 
              answer={`Sí, al ser un producto 100% digital, puedes comprarlo y usarlo desde cualquier país de Latinoamérica o Estados Unidos.`} 
            />
          </div>
        </div>
      </section>
