...
const CTAButton = ({ text = "QUIERO MI PROMOCIÓN AHORA", className = "" }) => (
  ...
  >
    ...
    <span className="text-sm md:text-base font-medium mt-1 opacity-90 flex items-center gap-1">
      <ShieldCheck className="w-4 h-4 md:w-5 md:h-5" /> (Compra 100% segura)
    </span>
  </motion.a>
);
    ...
    <div className="min-h-screen bg-white font-sans text-gray-800 selection:bg-pink-200 selection:text-pink-900 overflow-x-hidden pt-16 md:pt-20">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-purple-950 leading-[1.2] tracking-tight max-w-5xl mx-auto">
              Más de <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">1700 plantillas y páginas</span> listas para que puedas crear y vender en estas temporadas: <span className="text-pink-600 block mt-2">Día del Niño, Día del Maestro, Día de las Madres y Día del Padre</span>
            </h1>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
            ...
            >
              <p className="text-xl md:text-2xl text-gray-700 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                Edita fácilmente en Canva, personaliza los diseños y crea productos para vender o regalar.
              </p>
            ...
            >
              <img 
                src="https://i.imgur.com/HDtd2le.jpeg" 
                alt="Kit Papelería Creativa" 
                className="w-full max-w-md xl:max-w-lg mix-blend-multiply transform hover:scale-105 transition-transform duration-500"
                referrerPolicy="no-referrer"
              />
            </motion.div>
          </div>
          ...
          >
            {[
              ...
              <div key={i} className="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm border border-purple-100 flex flex-col items-center justify-center aspect-square hover:shadow-md transition-shadow">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-pink-100 to-purple-100 rounded-full flex items-center justify-center mb-3">
                  <item.icon className="w-8 h-8 md:w-10 md:h-10 text-purple-500" />
                </div>
                <span className="font-bold text-purple-900 text-center">{item.text}</span>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-20 px-4 bg-purple-50/50 border-y border-purple-100 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <SectionHeading 
            title="Mira ejemplos de lo que vas a poder crear" 
            subtitle="Diseños listos para editar en Canva y vender en temporadas altas."
          />
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-purple-900 to-purple-950 rounded-[3rem] p-8 md:p-16 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 mb-10 border border-white/20 relative">
              <div className="flex flex-col items-center justify-center mb-4">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-2xl text-gray-400 line-through">~~$499 MXN~~</p>
                </div>
              </div>
              <div className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-yellow-300 mb-6 drop-shadow-sm flex flex-col md:flex-row items-center justify-center gap-4">
                <span className="text-4xl md:text-5xl text-white">🔥 Precio especial hoy:</span>
                <span>$99 <span className="text-3xl">MXN</span></span>
              </div>
            ...
            <CTAButton className="text-2xl py-5 px-10 shadow-[0_0_40px_rgba(219,39,119,0.5)] w-full md:w-auto mb-10" />
